...
- [x] VICE-container `.vsf` snapshots with complete CPU/video machine state and
  guarded core-state import from VICE 3.10 (#126). See `docs/SNAPSHOTS.md` for
  the intentionally asymmetric Z80/VDC compatibility limits.
