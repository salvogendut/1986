...
assert(app.includes('_poc_set_real_drive'));assert(app.includes('_poc_set_display'));
assert(html.includes('F2 Play'));assert(app.includes('e.code==="F2"'));assert(app.includes('playTape'));console.log('UI contract tests passed');
